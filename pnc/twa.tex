...
A Restrição (\ref{DefCapFlow}) acumula multiplas funções: garante a continuidade dos percursos lógicos e a conservação dos comprimentos de onda; controla a
capacidade de tráfego dos canais lógicos, que também pode ser um \textit{uper bound} para o congestionamento; e anula as frações de fluxo agragado nas ligações
