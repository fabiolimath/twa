...
\cite{ram02}, o projeto completo de WRON é dividido em quatro sub-problemas, que serão denominados: roteamento de tráfego, projeto da topologia lógica,
roteamento de comprimentos de onda (WRS - \textit{Wavelength Routing Subproblem}) e alocação de comprimentos de onda (WAS - \textit{Wavelength Assignment
Subproblem}).
...
sub-problemas de TRS e WRS vem também sendo associados nos trabalhos que abordam o problema de \textit{grooming} de tráfego \cite{Leandro07}
 ...
 A contribuição principal deste trabalho é a proposição de uma nova modelagem para o projeto de redes ópticas, denominada TWA (\textit{Trafic over Wavelength
...
alta qualidadade e custo computacional despresível.
...
Na Seção \ref{lb} é apresentada uma adaptação do modelo TWA para a minização do congestionamento, juntamente com uma nova forma de calcular \textit{lower bounds}.
