...
heurísticas \cite{Sivarajan01,Nina07}. Todavia, o cálculo de \textit{lower bounds} (LB) que garantam essa qualidade tem elevado custo computacional, sendo esta
...
% 
% além de nos restringirmos ao VTD, consideraremos também a possibilidade de haver múltiplas ligações lógicas entre um mesmo par de nós da
...
seja, $\sum_n D_{in}$. Seja $\Psi_i$ a soma de todo o tráfego nas ligações lógicas iniciadas em $i$. Deste modo, $\Psi_i \geqslant \sum_n D_{in}$, considerando
que
