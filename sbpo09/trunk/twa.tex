...
capacidade do \textit{Optical switch} de receber ou originar conexões \cite{Zang00}. Todavia, o número de receptores ou 
...
ligações lógicas por fibra  $L$ (Dados \ref{adicionais}) \cite{Zang00,Jaumard04}. Ele pode ser usada para limitar cada ligação física, como é feito
pela 
Restrição (\ref{L}).
