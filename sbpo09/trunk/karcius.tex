...
publicados em \cite{Karcius04}, onde foi proposto um modelo para a resolução integrada do VTD e RWA. Este trabalho anterior é baseado nas
...
para a primeira solução viável. Isto demostra que o modelo mantém seu desempenho mesmo com uma rede de maior porte. Com esses resultados mostramos
a viabilidade da técnica aqui proposta, técnica esta que é totalmente baseada no modelo apresentado neste trabalho. 
