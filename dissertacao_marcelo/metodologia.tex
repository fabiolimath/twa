...
Para definição das formulações apresentadas para estimação da média, é suposto que a distribuição da média amostral é normal \cite{estatistica}. Isso ocorrerá
