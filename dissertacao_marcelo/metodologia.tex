...
Para estabelecer essa proporcionalidade, devemos obter uma razão adimensional que represente cada rede física, para então confrontá-las. Os parâmetros e
variáveis utilizados a seguir foram definidos no capítulo anterior.
...
de origem das ligações lógicas ($i$) é diferente da fonte de tráfego $s$. Esse limitante superior para o tráfego retransmitido nos permite garantir uma
