...
tamanhos, variando entre $10$ e $100$ nós. Empiricamente, estimamos que a esperança para o tráfego de acesso das populações do genético ($E_t$) é
razoavelmente
...
\begin{equation}
UBCFis = \dfrac{TIF_{NFSNET}\cdot (1-TIFgap)\cdot \sum_{mn} C_{mn}}{N-1}
\label{DefUBCFis}
\end{equation} 
