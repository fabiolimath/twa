...
múltipla de $0.5$ e foram definidas como a maior possível, desde que o \textit{upper bound} resultante não ultrapasse o respectivo mínimo amostral. A tabela
...
relaxamos os \textit{upper bounds} para congestionamento e tráfego retransmitido, reduzindo em $0.5$ o número de desvios padrão abaixo da média para ambos, nas
...
qual foi possível obter soluções viáveis foi o mesmo, independente do grau lógico. Além disso, pode-se notar que entre o \textit{backbone} e o \textit{cluster}
$1$, ambos com $5$ nós, o $TIFgap$ teve uma variação de $50\%$. Isto demonstra que a $TIF$ é mais influenciada pela carga de tráfego da rede em questão do que
pelo número de nós. Essas características cumprem o objetivo proposto na definição da $TIF$ de ser um parâmetro independente do grau lógico e do número de nós
da rede.
...
foi de apenas alguns segundos. O tempo total para resolução de todas as instâncias foi de $121$ horas.
