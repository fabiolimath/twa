...
int main(int argc, char** argv) {
  ...
  if(argc==1)
  {// Verifica se não foram passados os parâmetros e imprime a sintaxe.
...
// // Criterio de parada.
// GABoolean
// GATerminateUponScore(GAGeneticAlgorithm & ga){
//   
//    int bit = p.convergencia(ga.statistics().bestIndividual().score());
//    
//    if( bit )  
//     return gaTrue;
//   else
