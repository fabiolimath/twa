...
nó receba menos tráfego do que o destinado a ele. O MTB é assim definido como o mínimo dos valores calculados nas equações do conjunto de Dados (\ref{MT}), na
seção seginte. 
