...
\newcommand{\lk}[1]{{\textcolor{blue}{\url{http://#1}}}}
...
\newtheorem{teor}{}%[chapter]
\newenvironment{ferr}{\begin{teor}  }{\end{teor}}
...
\newtheorem{var}{Variável}[section]
\newtheorem{definicao}{Definição}
% \newtheorem{vars}{}[chapter]
