...
KS-$p$, tanto para o valor de congestionamento quanto para o número de comprimentos de onda utilizados. Com exceção do grau lógico $11$ para a matriz $P1$,
onde o valor de congestionamento obtido é um pouco superior ao UB. Além disso, foram
obtidas soluções ótimas para
...
se comparado ao \textit{lower bound} obtido em \cite{Sivarajan01}, pois foi calculado em menos de $0.01$ segundos. Esse é um resultado expressivo, frente
