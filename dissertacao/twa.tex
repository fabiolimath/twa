...
Como as rotas físicas podem não ser unicamente determinadas pelo forma básica do TWA, não se pode determinar com exatidão a distância percorrida por cada
rota. Consequentemente, o mesmo se aplica ao tráfego que for alocado em cada rota. Essa a principal limitação do modelo básico, pois impede que o fator BL
