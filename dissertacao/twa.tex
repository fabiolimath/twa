...
Isto é suficiente para modelar a distribuição do tráfego, embora na implementação real de múltiplas rotas físicas entre um mesmo par de nós 
...
de configuração da rede. Isso não influencia na modelagem e portanto não será tratado aqui.
...
\begin{equation}
 \label{Obj:B}
 \text{\small Minimize: } \sum_{i,m,n,w} B_{i,m,n,w}.
\end{equation}
