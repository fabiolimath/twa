...
Cada par $(i,j)$ é visto nas restrições de controle de fluxo como um único caminho, unindo todos os planos lógicos. Se o par representa na verdade múltiplas
...
essas restrições funcionam da mesma forma que \cite{ram96}. Portanto, são as restrições de conservação de fluxo que fazem a correlação ente os planos
lógicos.
