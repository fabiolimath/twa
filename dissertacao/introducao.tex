...
No item $a$ da Figura \ref{fig:dem_traf} está representada a distribuição da demanda de tráfego $d_{16}$, com origem no nó $1$ e destinada ao nó $6$, sobre
...
partes, uma contento $2/3$ do tráfego original e outra com o $1/3$ restante. A primeira parte foi designada à ligação lógica $p_5$, atingindo diretamente o
destino, e a segunda parte foi roteada pela caminho formado pelas ligações lógicas $p_2$ e $p_4$. Pelo primeiro caminho o tráfego foi entregue
...
\begin{figure}[htb]
	...
	\caption{Demanda de Tráfego $d_{16}$ distribuída na Topologia Lógica}
	\label{fig:dem_traf}
\end{figure}
...
$d_{16}$, de acordo com o esquema apresentado no item $a$ da Figura \ref{fig:rotas_fisicas}. Note que o tráfego passou também pelos nós $2$, $3$, e $5$,
