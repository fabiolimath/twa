...
Em \cite{Sivarajan01} foram feitos testes para uma rede de $14$ nós, a mesma que será estuda na seção seguinte \cite{ram96}. Segundo os autores, a
...
cada instância. A otimalidade, quanto ao congestionamento, só pôde ser garantida nesses resultados quando o valor viável encontrado era igual ao
...
O computador onde foram executados os experimentos desta seção possui a seguinte configuração: 
...
\ref{fig:p1} e \ref{fig:p2}, respectivamente, estão as matrizes de demandas $P1$ e $P2$ da NSFNET \cite{ram02}. Já na Tabela
...
Nas Tabelas \ref{p1} e \ref{p2} são confrontados os resultados obtidos com o TWA$c_1$ e os encontrados em \cite{Sivarajan01}, com o modelo KS. Para cada
grau
...
pelo SCIP para chegar a essa solução; na coluna $W$, o número de comprimentos de onda utilizados pelo TWA$c_1$; e na coluna MTB, o \textit{Minimum Trafic
Bound}
para cada instância. Também são exibidos, para o modelo KS, na coluna $UB$, as melhores soluções para o congestionamento encontradas em  \cite{Sivarajan01},
e nas
colunas $LB$ e $W$, os respectivos \textit{lower bounds} e  número de comprimentos de onda utilizados pelo KS. Quando o valor de congestionamento
corresponde ao
