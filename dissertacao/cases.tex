...
pelo seu limite natural ($GFout_v$), adotou-se a constante $CON_v$, que pode ser menor que $GFout_v$. 

A Restrição \ref{rest:DefCapFlow} do modelo básico é substituída, pelas restrições \ref{cases:rest:Desvios} e \ref{cases:rest:ConservBgeral} a seguir.
Dentre estas
